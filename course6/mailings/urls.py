...
from .views import IndexView, ContactFormView, MessageCreateView, \
    ...
    StatusMailingSettingsUpdateView, MailingLogListView, ClientListView, \
...
urlpatterns = [
    ...
    path('status_update/<int:pk>/', StatusMailingSettingsUpdateView.as_view(),
         name='status_update'),

    path('mailing_log/<int:pk>/', MailingLogListView.as_view(),
         name='mail_log'),
